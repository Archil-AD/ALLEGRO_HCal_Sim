...
if runPandora:
    ...
    pandora.Parameters = {
        ...
        "HCalToHadGeVCalibration": ["1.15"],  # ALLEGRO HCAL approximate number valid for particles with E > 10 GeV
        ...
        "HadConstantTerm": ["0.032"], # ALLEGRO standalone-HCAL kaon0L resolution @ 68 degree
        "HadStochasticTerm": ["0.41"], # ALLEGRO standalone-HCAL kaon0L resolution @ 68 degree
    }
    TopAlg += [pandora]


    perfectPFA = MarlinProcessorWrapper('DDMarlinPandoraPFA')
    perfectPFA.OutputLevel = INFO
    perfectPFA.ProcessorType = 'DDPandoraPFANewProcessor'
    perfectPFA.Parameters = {
        "PandoraSettingsXmlFile": ["PandoraSettingsPerfectPFA.xml"],
        "PFOCollectionName" : ["PerfectPFOs"],
        "ClusterCollectionName": ["PerfectPFOClusters"],
        "StartVertexCollectionName": ["PerfectPFANewStartVertices"],
        "StartVertexAlgorithmName": ["PerfectPFANew"],
        "ECalMipThreshold": ["0."],
        "HCalMipThreshold": ["0."],
        "ECalToHadGeVCalibrationBarrel": ["1."],  # this must be calculated for ALLEGRO
        "ECalToHadGeVCalibrationEndCap": ["1."],  # this must be calculated for ALLEGRO
    ...
    perfectPFA.Lcio2EDM4hepTool = lcioConvTool
    ...
    perfectPFA.EDM4hep2LcioTool = edm4hepConvTool
